...
class User {
  ...
  static async create(user) {
    const query = 'INSERT INTO "Users" (user_name, email, password_hash, user_status, user_role) VALUES ($1, $2, $3, $4, $5) RETURNING *';
  ...
  static async update(id, updatedUser) {
    const query = 'UPDATE "Users" SET user_name = $1, email = $2, user_status = $3, user_role = $4 WHERE user_id = $5';
  ...
  static async getByName(name) {
    const query = 'SELECT user_id, user_name, email, user_status, user_role FROM "Users" WHERE user_name ILIKE $1';
